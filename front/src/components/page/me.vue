        ...
        <app-body>
            ...
            <div v-show="eidtAddress" class="address-container">
                <el-page-header class="address-container-back" @back="eidtAddress=false"
                                content="编辑收货地址"></el-page-header>
                <div class="address-form-container">
                    <div class="address-container-add-title">新增/修改收货地址</div>
                    <el-form :model="addressInfo" ref="addressForm" label-width="100px">
                        <el-form-item label="快速定位">
                            <el-button type="primary" plain @click="getCurrentLocation" icon="el-icon-location-outline">获取当前位置</el-button>
                        </el-form-item>
                        <el-form-item label="收货人姓名" prop="consigneeName">
                            <el-input placeholder="请输入收货人姓名" v-model="addressInfo.consigneeName" maxlength="10" show-word-limit></el-input>
                        </el-form-item>
                        <el-form-item label="手机号" prop="consigneePhone">
                            <el-input placeholder="请输入收货人手机号" v-model="addressInfo.consigneePhone" onkeyup="this.value=this.value.replace(/[^\d.]/g,'');" maxlength="11" show-word-limit></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="详细地址" prop="detailAddress">
                            <el-input placeholder="请输入详细地址（如道路、门牌号、小区、楼栋号等信息）" v-model="addressInfo.detailAddress" maxlength="50" show-word-limit></el-input>
                        </el-form-item>
                        <el-form-item>
...
export default {
    ...
    mounted() {
        // 如果editAddress为true，默认打开编辑地址窗口
        if (this.$route.query.editAddress === 'true') {
                        ...
                        fetch(`https://restapi.amap.com/v3/geocode/regeo?output=json&location=${longitude},${latitude}&key=${apiKey}`)
                            ...
                            .then(data => {
                                if (data.status === '1' && data.regeocode) {
                                    ...
                                    this.addressInfo.detailAddress = detail;
